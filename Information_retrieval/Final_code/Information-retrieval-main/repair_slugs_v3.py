...
def create_slug(title, limit=70):
...
def main():
    print(f"Repairing URLs with truncation in {PUBLICATIONS_JSONL}...")
    ...
    print("Re-indexing...")
    # Also update source_url for consistency if needed, but primary is publication_url
